...
On macOS or Linux, use the same `custom_nodes` location from a shell:
...
Then restart ComfyUI using your usual launcher, such as `run_nvidia_gpu.bat` on Windows or your normal shell command on macOS/Linux.
